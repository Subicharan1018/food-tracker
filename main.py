...
from app.routers import meal_plan, workout, food_parser, digest, recipes, foods, pacing, shopping
...
app.include_router(shopping.router,    prefix="/api", tags=["Shopping"], dependencies=api_dependencies)
